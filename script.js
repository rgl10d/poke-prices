var pokemonArray = ["Bulbasaur", "Ivysaur", "Venusaur", "Charmander", "Charmeleon", "Charizard", "Squirtle",
...
$("#srch-set-button").on("click", (event) => {
    $("#display-card").html("");
    setSearch = $("#srch-set-bar").val();
    pokemoncardURL = "https://api.pokemontcg.io/v1/cards?set=" + setSearch;
    event.preventDefault();
    $.ajax({
        url: pokemoncardURL,
        method: "GET"
